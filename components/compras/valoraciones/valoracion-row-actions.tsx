...
import { deshabilitarReporteMaquinariaCompra, type ValoracionCompraItem } from "@/lib/actions/compras"

interface Props {
    row: ValoracionCompraItem
}

export function ValoracionCompraRowActions({ row }: Props) {
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            ...
                            onClick={async (e) => {
                                e.preventDefault()
                                setPending(true)
                                const res = await deshabilitarReporteMaquinariaCompra(row.id)
                                setPending(false)
                                if (res.success) {
